...
W = 52
print("="*W)
print(f"   SMP COMMAND CENTRE DASHBOARD   |   WEEK2024-W47")
print("="*W)
...
export = {
    "week":"2024-w47",
    "members":{"total": len(raw_members), "goal met": len(goal_met), "avg steps": avg_steps},
    "weekly": {"best day": best_day, "total_steps": sum(daily_steps)},
